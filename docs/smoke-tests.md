...
the shared mock answers `GetHeight` with 0 for every frame, and kit 18 (LibKa0s v1.33.0) did not
flip that either: the flip ships alone, at kit 19 at the earliest, not here. **So a
