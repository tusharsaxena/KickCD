...
└── settings/
    ...
    ├── General.lua   — 2 tabs. Master controls (6): the CANONICAL block
                        ...
                        from Target" button PAIRED ON ONE LINE through
