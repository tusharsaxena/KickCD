...
-- Debug diagnostics (Castbar:DebugDump) were peeled to modules/Castbar_Debug.lua
-- to keep this file under the 1500 hard cap; a further split of the config-driven
-- build (Reskin / sizing / anchors) from the per-cast update path (RenderCast)
-- remains a candidate if it grows again.
--
