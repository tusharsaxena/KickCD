...
KickCD.DefaultSpells = {
    ...
    DEMONHUNTER = {
        HAVOC = {
            ...
            { spellID = 370965, category = "stun",         enabled = true }, -- The Hunt -- TBD: verify in 12.0.5
        },
        VENGEANCE = {
            { spellID = 183752, category = "interrupt",    enabled = true }, -- Disrupt
            { spellID = 179057, category = "stun",         enabled = true }, -- Chaos Nova
            { spellID = 217832, category = "incapacitate", enabled = true }, -- Imprison
            { spellID = 207684, category = "fear",         enabled = true }, -- Sigil of Misery
            { spellID = 202138, category = "stun",         enabled = true }, -- Sigil of Chains -- TBD: verify in 12.0.5
        },
    },
    ...
    DRUID = {
        BALANCE = {
            ...
            { spellID = 5211,   category = "stun",      enabled = true }, -- Mighty Bash -- TBD: verify in 12.0.5
        ...
        RESTORATION = {
            { spellID = 5211,   category = "stun",         enabled = true }, -- Mighty Bash -- TBD: verify in 12.0.5
            { spellID = 132469, category = "knockback",    enabled = true }, -- Typhoon -- TBD: verify in 12.0.5
            { spellID = 33786,  category = "incapacitate", enabled = true }, -- Cyclone
            { spellID = 339,    category = "root",         enabled = true }, -- Entangling Roots
        },
    },
    ...
    EVOKER = {
        DEVASTATION = {
            ...
            { spellID = 372048, category = "fear",      enabled = true }, -- Oppressing Roar -- TBD: verify in 12.0.5
            { spellID = 357214, category = "knockback", enabled = true }, -- Wing Buffet -- TBD: verify in 12.0.5
            { spellID = 360806, category = "incapacitate", enabled = true }, -- Sleep Walk -- TBD: verify in 12.0.5
        },
        PRESERVATION = {
            { spellID = 351338, category = "interrupt", enabled = true }, -- Quell
            { spellID = 372048, category = "fear",      enabled = true }, -- Oppressing Roar -- TBD: verify in 12.0.5
    ...
    HUNTER = {
        BEASTMASTERY = {
            ...
            { spellID = 213691, category = "incapacitate", enabled = true }, -- Scatter Shot -- TBD: verify in 12.0.5
        },
        MARKSMANSHIP = {
            { spellID = 147362, category = "interrupt", enabled = true }, -- Counter Shot
            { spellID = 109248, category = "stun",      enabled = true }, -- Binding Shot
        ...
        SURVIVAL = {
            ...
            { spellID = 109248, category = "stun",         enabled = true }, -- Binding Shot
            { spellID = 187650, category = "incapacitate", enabled = true }, -- Freezing Trap
            { spellID = 19577,  category = "stun",         enabled = true }, -- Intimidation -- TBD: verify in 12.0.5
        },
    },
    ...
    PALADIN = {
        HOLY = {
            { spellID = 31935,  category = "silence", enabled = true }, -- Avenger's Shield -- TBD: verify in 12.0.5
    ...
    PRIEST = {
        DISCIPLINE = {
            { spellID = 15487,  category = "silence",      enabled = true }, -- Silence -- TBD: verify in 12.0.5
            { spellID = 605,    category = "incapacitate", enabled = true }, -- Mind Control -- TBD: verify in 12.0.5
            { spellID = 8122,   category = "fear",         enabled = true }, -- Psychic Scream
            { spellID = 64044,  category = "stun",         enabled = true }, -- Psychic Horror -- TBD: verify in 12.0.5
        },
        HOLY = {
            { spellID = 8122,   category = "fear",         enabled = true }, -- Psychic Scream
            { spellID = 605,    category = "incapacitate", enabled = true }, -- Mind Control -- TBD: verify in 12.0.5
        ...
        SHADOW = {
            ...
            { spellID = 605,    category = "incapacitate", enabled = true }, -- Mind Control -- TBD: verify in 12.0.5
            { spellID = 375901, category = "incapacitate", enabled = true }, -- Mindgames -- TBD: verify in 12.0.5
        },
    },
    ...
    ROGUE = {
        ...
        OUTLAW = {
            ...
            { spellID = 1833,   category = "stun",         enabled = true }, -- Cheap Shot
            { spellID = 2094,   category = "incapacitate", enabled = true }, -- Blind
            { spellID = 152150, category = "stun",         enabled = true }, -- Death from Above -- TBD: verify in 12.0.5
        },
        SUBTLETY = {
            { spellID = 1766,   category = "interrupt",    enabled = true }, -- Kick
            { spellID = 408,    category = "stun",         enabled = true }, -- Kidney Shot
    ...
    SHAMAN = {
        ...
        RESTORATION = {
            ...
            { spellID = 192058, category = "stun",         enabled = true }, -- Capacitor Totem
            { spellID = 51514,  category = "incapacitate", enabled = true }, -- Hex
            { spellID = 51490,  category = "knockback",    enabled = true }, -- Thunderstorm -- TBD: verify in 12.0.5
        },
    },
    ...
    WARLOCK = {
        ...
        DEMONOLOGY = {
            { spellID = 19647,  category = "interrupt",    enabled = true }, -- Spell Lock (Felhunter)
            { spellID = 119910, category = "interrupt",    enabled = true }, -- Optical Blast (Observer) -- TBD: verify in 12.0.5
            { spellID = 30283,  category = "stun",         enabled = true }, -- Shadowfury
            { spellID = 6789,   category = "fear",         enabled = true }, -- Mortal Coil
            { spellID = 5782,   category = "fear",         enabled = true }, -- Fear
        },
